...
from app.routers import auth, courier, courier_admin, customers, inventory, orders, product_attributes, receiving, skus, suppliers
...
app.include_router(courier_admin.router, prefix="/api")
