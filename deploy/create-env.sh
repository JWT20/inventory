...
require_envfile_safe ADVICE_SALES_API_KEY "${ADVICE_SALES_API_KEY:-}"
require_envfile_safe ADVICE_PRODUCTS_BASE_URL "${ADVICE_PRODUCTS_BASE_URL:-}"
require_envfile_safe ADVICE_PRODUCTS_API_KEY "${ADVICE_PRODUCTS_API_KEY:-}"
require_envfile_safe ADVICE_PRODUCTS_VERCEL_BYPASS_SECRET \
  "${ADVICE_PRODUCTS_VERCEL_BYPASS_SECRET:-}"
...
if [[ -n "${ADVICE_PRODUCTS_SYNC_INTERVAL_SECONDS:-}" \
  && ! "${ADVICE_PRODUCTS_SYNC_INTERVAL_SECONDS}" =~ ^[0-9]+$ ]]; then
  echo "ADVICE_PRODUCTS_SYNC_INTERVAL_SECONDS must be a non-negative integer." >&2
  exit 1
fi
...
ADVICE_PRODUCTS_BASE_URL=${ADVICE_PRODUCTS_BASE_URL:-}
ADVICE_PRODUCTS_API_KEY=${ADVICE_PRODUCTS_API_KEY:-}
ADVICE_PRODUCTS_VERCEL_BYPASS_SECRET=${ADVICE_PRODUCTS_VERCEL_BYPASS_SECRET:-}
ADVICE_PRODUCTS_SYNC_INTERVAL_SECONDS=${ADVICE_PRODUCTS_SYNC_INTERVAL_SECONDS:-3600}
ENVEOF
